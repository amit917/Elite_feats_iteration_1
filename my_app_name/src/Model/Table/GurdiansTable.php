 ...
 *
 * @method \App\Model\Entity\Gurdian newEmptyEntity()
 * @method \App\Model\Entity\Gurdian newEntity(array $data, array $options = [])
 ...
 * @method \App\Model\Entity\Gurdian[] patchEntities(iterable $entities, array $data, array $options = [])
 ...
 * @method \App\Model\Entity\Gurdian[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\Gurdian[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \App\Model\Entity\Gurdian[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\Gurdian[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 */
